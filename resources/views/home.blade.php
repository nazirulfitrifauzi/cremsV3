    ...
    <div class="h-screen flex overflow-hidden bg-gray-100" x-data="{ sidebarOpen: false }"
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
                    ...
                    <div class="flex-1 flex items-center ">
                        <div class="w-full flex md:ml-0">
                                <h3 class="text-xl font-semibold text-gray-600">
                                    Hello {{ ucwords(strtolower(implode(' ', array_slice(explode(' ', auth()->user()->name), 0, 2)))) }}
                                </h3>
                        </div>
                    </div>
                    <div class="ml-4 flex items-center md:ml-6">
                        <span class="inline-block relative">
                            ...
                            aria-label="Notifications">
                                ...
                                <span class="absolute top-0 right-0 block h-3 w-3 rounded-full text-white shadow-solid bg-red-400"></span>
                            </button>
                        </span>
            ...
            <main class="flex-1 relative z-0 overflow-y-auto py-6 focus:outline-none" tabindex="0" x-data=""
                ...
                <!-- Notification -->
                @if (session('status'))
                <div class="fixed mt-12 inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end notification">
