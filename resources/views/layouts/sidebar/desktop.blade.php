        ...
        <div x-data="{}" x-cloak>
            ...
            >
                <a href="#" @click.prevent="open = !open"
                    class="{{ (auth()->user()->uals->attendances == 1 || auth()->user()->uals->leaves == 1 || auth()->user()->uals->claims == 1) ? 'block' : 'hidden' }} mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-300 rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700 transition ease-in-out duration-150">
