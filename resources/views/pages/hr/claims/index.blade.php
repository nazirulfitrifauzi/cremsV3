...
@section('content')
        <main class="flex-1 relative z-0 overflow-y-auto py-6 focus:outline-none" tabindex="0" x-data=""
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div 
                    class="py-4"
                    x-data="{ tab: 'all', ...approve_modal(), ...reject_modal() }"
                >
                                        ...
                                        @forelse ($personal as $personals)
                                            <tr class="hover:bg-blue-100 transition duration-150 ease-in-out">
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-600">
                                                    @if($personals->type == 'CLM')
                                                        Medical
                                                    @elseif($personals->type == 'CLO')
                                                        Others
                                                    @endif
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-600">
                                                    {{ date('d/m/Y', strtotime($personals->created_at) )  }}
                                                </td>
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-600">
                                                    <span class="inline-flex rounded-md shadow-sm mx-1">
                                                        <a href="{{ asset('storage/' . $personals->attachment) }}" type="button" target="_blank"
                                                            ...
                                                            {{ str_replace('/', '_', $personals->attachment)  }}
                                                        </a>
                                                    </span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-600">
                                    ...
                                    <tbody class="bg-white">
                                        @forelse ($claim as $claims)
                                            <tr class="hover:bg-blue-100 transition duration-150 ease-in-out">
                                                ...
                                                @if (auth()->user()->ual == '1' || auth()->user()->ual == '2')
                                                    @if($claims->status == 0)
                                                        @if($claims->user_id != auth()->user()->id)
                                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 text-gray-600">
